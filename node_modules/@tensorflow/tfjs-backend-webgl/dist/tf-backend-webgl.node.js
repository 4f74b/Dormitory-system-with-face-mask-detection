...
function getUniformLocations(gpgpu, program, webGLProgram) {
    ...
    for (var i = 0; i < program.variableNames.length; i++) {
        ...
        uniformLocations["offset".concat(varName)] =
            gpgpu.getUniformLocation(webGLProgram, "offset".concat(varName), shouldThrow);
        if (program.enableShapeUniforms) {
...
var MathBackendWebGL = /** @class */ (function (_super) {
     ...
     * be created.
     */
    MathBackendWebGL.prototype.createTensorFromTexture = function (values, shape, dtype) {
