...
describe('SavedModel', function () {
    ...
    it('read non-exist file', function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, saved_model_1.readSavedModelProto)('/not-exist')];
                case 1:
                    _a.sent();
                    done.fail();
                    return [3 /*break*/, 3];
    ...
    it('load TFSavedModel with wrong tags throw exception', function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('load TFSavedModel with wrong signature throw exception', function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('delete TFSavedModel multiple times throw exception', function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var model;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('throw error when input tensors do not match input ops', function (done) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('execute model with wrong tensor name', function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var model, input;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, tf.node.loadSavedModel('./test_objects/saved_model/times_three_float', ['serve'], 'serving_default')];
