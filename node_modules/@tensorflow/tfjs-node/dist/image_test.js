...
describe('decode images', function () {
    ...
    it('throw error if request non int32 dtype', function (done) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('throw error if decode invalid image type', function (done) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('throw error if backend is not tensorflow', function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var testBackend_1, uint8array, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    testBackend_1 = new jasmine_util_1.TestKernelBackend();
                    (0, tfjs_1.registerBackend)('fake', function () { return testBackend_1; });
                ...
                case 2:
                    ...
                    expect(err_1.message)
                        .toBe('Expect the current backend to be "tensorflow", but got "fake"');
