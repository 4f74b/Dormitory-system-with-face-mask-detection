...
describe('Ops are exported from index and work', function () {
    it('tf.mul works', function () { return __awaiter(void 0, void 0, void 0, function () {
        var a, b, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, a.mul(b).data()];
                case 1:
                    _b.apply(_a, [_c.sent(), [3, 8, 15]]);
                    return [2 /*return*/];
            }
        });
    }); });
});
describe('packages merge', function () {
