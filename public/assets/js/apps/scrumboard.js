  ...
  function $_taskAdd(getParent) {
    $('[data-btnfn="addTask"]')
      ...
      .on("click", function (event) {
        ...
        const file = document.getElementById("input-file-max-fs").value;
        console.log(file);
        ...
        if ($_taskText == "") {
          ...
          $html =
            ...
            $_taskText +
            "</p>" +
            '<div class="row"> <div class="col-md-12"> <div class=" mt-4 pr-md-4"> <a class="dropify-wrapper has-preview" href="/test.docx"> <div class="dropify-message"><span class="file-icon"></span> <p>Click to Upload or Drag n Drop</p> <p class="dropify-error">Ooops, something wrong appended.</p> </div> <div class="dropify-loader" style="display: none;"> </div> <div class="dropify" data-default-file="/test.docx"> </div><button type="button" class="dropify-clear"><i class="flaticon-close-fill"></i></button> <div class="dropify-preview" style="display: block;"> <span class="dropify-render"><i class="dropify-font-file"></i><span class="dropify-extension">docx</span></span> </div> </a> </div> </div> </div>' +
            "</div>" +
            '<div class="task-bottom">' +
            '<div class="tb-section-1">' +
            '<span data-taskDate="' +
  ...
  $(".add-list")
    ...
    .on("click", function (event) {
      ...
      $html =
        ...
        '" class="col-md-4 mb-4" style="padding: unset;padding-right:15px;" data-connect="sorting">' +
        '<div class="connect-sorting">' +
        '<div class="task-container-header d-flex flex-column p-0">' +
        '<div class="d-flex justify-content-center"> <svg class="" xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 64 64" fill="red" stroke="#000000"> <line x1="8" y1="56" x2="24" y2="40" /> <path d="m52 28 4-4-4-4-8-8-4-4-4 4a5.66 5.66 0 0 0 0 8l-8 8a11.31 11.31 0 0 0-16 0l23.94 24.12L36 52a11.36 11.36 0 0 0 0-16l8-8a5.66 5.66 0 0 0 8 0z" /> </svg> </div>' +
    ...
    $(".card .s-task-delete")
      ...
      .on("click", function (event) {
        ...
        $('[data-remove="task"]').on("click", function (event) {
          event.preventDefault();
          /* Act on the event */
          get_card_parent[0].parentElement.parentElement.parentElement.remove();
